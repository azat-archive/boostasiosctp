...
class sctp_socket_acceptor
  : public basic_socket_acceptor<Protocol, sctp_socket_acceptor_service<Protocol> >
{
public:
   typedef typename basic_socket_acceptor<Protocol, sctp_socket_acceptor_service<Protocol> >::protocol_type protocol_type;
   typedef typename basic_socket_acceptor<Protocol, sctp_socket_acceptor_service<Protocol> >::endpoint_type endpoint_type;
   typedef typename basic_socket_acceptor<Protocol, sctp_socket_acceptor_service<Protocol> >::native_type native_type;

   /// Construct an acceptor without opening it.
   explicit sctp_socket_acceptor(boost::asio::io_service& io_service)
     : basic_socket_acceptor<Protocol, sctp_socket_acceptor_service<Protocol> >(io_service)
   {
   }
   ...
   sctp_socket_acceptor(boost::asio::io_service& io_service,
     ...
     : basic_socket_acceptor<Protocol, sctp_socket_acceptor_service<Protocol> >(io_service, protocol)
   {
   }
   ...
   sctp_socket_acceptor(boost::asio::io_service& io_service,
     ...
     : basic_socket_acceptor<Protocol, sctp_socket_acceptor_service<Protocol> >(io_service, endpoint, reuse_addr)
   {
   }
   ...
   sctp_socket_acceptor(boost::asio::io_service& io_service,
     ...
     : basic_socket_acceptor<Protocol, sctp_socket_acceptor_service<Protocol> >(io_service, protocol, native_acceptor)
   {
   }
