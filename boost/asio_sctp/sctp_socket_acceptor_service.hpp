...
class sctp_socket_acceptor_service
  : public socket_acceptor_service<Protocol>
{
public:
   typedef typename socket_acceptor_service<Protocol>::implementation_type implementation_type;
   typedef typename socket_acceptor_service<Protocol>::endpoint_type endpoint_type;
      ...
      const endpoint_type& endpoint, boost::system::error_code& ec)
  {
    ...
    detail::sctp_socket_ops::bind_add(native(impl), endpoint.data(), endpoint.size(), ec);
    return ec;
  }
      ...
      const endpoint_type& endpoint, boost::system::error_code& ec)
  {
    ...
    detail::sctp_socket_ops::bind_remove(native(impl), endpoint.data(), endpoint.size(), ec);
    return ec;
  }
};
